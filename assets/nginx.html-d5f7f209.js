...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>方式二：</strong></p><p>源码编译安装：</p><ol><li>下载nginx源码到自己电脑上</li><li>执行预编译：<code>./configure</code></li><li>编译：<code>make</code></li><li>安装：<code>make install</code></li></ol><p>这种方式比较灵活，可以自定义配置各种参数，适合于一些特殊的应用场景，比如想安装一些特殊模块或者想修改一些源码来自定义一些功能，再或者要求安装在服务器上的Nginx不能访问外网等。</p><p><strong>方式三：</strong></p><p>适用docker进行安装</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull nginx
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="服务启停止" tabindex="-1"><a class="header-anchor" href="#服务启停止" aria-hidden="true">#</a> 服务启停止</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># linux 回车后没有提示消息即成功</span>
nginx

<span class="token comment"># windows</span>
start nginx 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>查看nginx后台进程</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">ps</span> -ef<span class="token operator">|</span><span class="token function">grep</span> nginx
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>关注两个进程，一个master进程，一个worker进程</p><figure><img src="`+r+`" alt="nginx进程模型" tabindex="0" loading="lazy"><figcaption>nginx进程模型</figcaption></figure><p>这里的master进程就是nginx的主进程，它主要负责读取和验证配置文件以及管理worker进程，worker进程就是nginx的工作进程，负责处理实际的请求，master进程只有一个，而worker进程可以有多个。</p><p>worker进程的数量可以通过配置文件进行修改</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看端口号占用情况</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="静态站点部署" tabindex="-1"><a class="header-anchor" href="#静态站点部署" aria-hidden="true">#</a> 静态站点部署</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看nginx的安装目录、编译参数以及配置文件和日志文件的位置等各种信息，尤其是nginx配置文件的位置，也就是nginx.conf这个文件</span>
<span class="token comment"># 这个文件位置和使用的操作系统以及安装的nginx方式有关</span>
nginx <span class="token parameter variable">-V</span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>也可以输入<code>nginx -t</code>回车后,<code>--con-path=</code>后面的就是配置文件的路径，常见位置：</p><ul><li><code>/etc/nginx/conf</code></li><li><code>/usr/local/etc/nginx</code></li><li><code>/opt/homebrew/etc/nginx</code></li></ul><p><code>nginx.conf</code>常见配置：</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code>worker_processes  <span class="token number">10</span>; <span class="token comment">//worker进程数量，一般来说，修改为同服务器CPU内核数量是比较合适的，也可以设置为auto，这样就会自动根据CPU内核的数量来自动设置worker进程的数量</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>修改完成<code>nginx.conf</code>配置文件后，可使用<code>nginx -t</code>来检查配置文件是否错误，每次修改完都要利用<code>nginx -s reload</code>重新加载配置文件。</p><h2 id="配置文件" tabindex="-1"><a class="header-anchor" href="#配置文件" aria-hidden="true">#</a> 配置文件</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>events <span class="token punctuation">{</span>
...
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>include字段：</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 绝对路径</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>举个例子，将http下的server配置，一个配置http，一个配置https拆分开：</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># nginx.conf里</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>servers文件夹有http和https两个文件：<br><img src="`+u+`" alt="" loading="lazy"></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># http文件里</span>
...
server <span class="token punctuation">{</span>
   ...
   <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="反向代理和负载均衡" tabindex="-1"><a class="header-anchor" href="#反向代理和负载均衡" aria-hidden="true">#</a> 反向代理和负载均衡</h2><p>反向代理是相对正向代理来说的，正向代理就是代理客户端，反向代理就是代理服务器端。</p><p>比如挂VPN访问国外网站，让VPN代替我们访问国外的网站，然后把返回结果返回到我们客户端，这就是一个典型的正向代理例子。这里的代理服务器代理的是客户端，且这个过程客户端是知道的，但是对于服务端是透明的。</p><p>而反向代理就是代理服务端，比如当我们访问一个网站的时候，比如我们访问Google，而Google域名只有一个，但是Google后面有很多的服务器，客户端请求Google网页，而Google服务器会将请求转发到后面的服务器上，从而隐藏了真实的服务器地址，端口等信息，这就是反向代理的典型例子。这里的代理服务器就是代理的服务端，而且这个过程对于客户端是透明的。Nginx就是一个非常好的反向代理服务器。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>http <span class="token punctuation">{</span>
    upstream backend <span class="token punctuation">{</span>
        ip_hash<span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="https配置" tabindex="-1"><a class="header-anchor" href="#https配置" aria-hidden="true">#</a> HTTPS配置</h2><p>HTTP + SSL = HTTPS</p><p>HTTP默认端口为80，HTTPS默认端口为443。在浏览器地址栏中，这两个端口号都不会显示。</p><p>可以通过openssl来生成一个自签名证书：</p><ol><li>生成私钥文件(private key)：<code>openssl genrsa -out private.key 2048</code></li><li>根据私钥文件生成证书签名请求文件（Certificate Signing Request，简称CSR文件）：<code>openssl req -new -key private.key -out cert.csr</code></li><li>根据私钥对证书申请进行签名从而生成证书文件（pem文件）：<code>openssl x509 -req -in cert.csr -out cacert.pem -signkey private.key</code></li></ol><p>生成过程中会提示输入一些信息，如国家(Country)、省份(Province)、城市(Locality Name)、公司(Unit Name)、名字(Common Name)、邮箱(Email Address)等等</p><p>最后需要两个文件，一个pem文件，一个key文件，需要放在服务器上。然后在nginx的配置文件下进行配置。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>server <span class="token punctuation">{</span>
    listen      <span class="token number">443</span> ssl<span class="token punctuation">;</span>
    server_name localhost<span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>**注意：**自签名证书未经过CA机构的验证，所以浏览器访问会报不安全的，选择继续访问即可。</p>`,62),b=n(`<h2 id="虚拟主机" tabindex="-1"><a class="header-anchor" href="#虚拟主机" aria-hidden="true">#</a> 虚拟主机</h2><p>虚拟主机可以在一台主机上部署多个站点，很多时候网站在起步阶段并没有非常大的访问量，把多个网站部署在一起也不会对服务器造成太大的压力，而且这样可以节省服务器的资源和成本，nginx的虚拟主机就是通过<code>server</code>块来进行配置的。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 每个虚拟块就是一个虚拟主机</span>
server <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以把<code>server</code>块的内容复制，然后在<code>server</code>文件夹下新建文件，这样主配置文件就看起来更干净、简洁。</p><h2 id="允许跨域与允许使用history路由" tabindex="-1"><a class="header-anchor" href="#允许跨域与允许使用history路由" aria-hidden="true">#</a> 允许跨域与允许使用history路由</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>location / <span class="token punctuation">{</span>
    ...
    index  index.html index.htm<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6);function k(h,g){const s=e("RouterLink");return i(),l("div",null,[c(" more "),m,t("p",null,[p(s,{to:"/devops/https/centos-nginx-https.html"},{default:o(()=>[d("详细Centos玩转https可以参考此文章")]),_:1})]),b])}const f=a(v,[["render",k],["__file","nginx.html.vue"]]);export{f as default};
